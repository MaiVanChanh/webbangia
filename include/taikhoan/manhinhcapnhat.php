...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="border:#CCCCCC 1px solid; margin-top:3px;">
					<tr>
						<td>
						  ...
						  <table width="100%" border="0" cellpadding="3" cellspacing="0" align="center" class="dongbang" style="border-top:#CCCCCC 1px solid;border-right:#CCCCCC 1px solid; margin-top:10px; margin-bottom:10px;">
                            <tr>
                            ...
                            <tr>
                              <td>&nbsp;&nbsp;Họ&nbsp;
                                ...
                                <input name="ho" type="text" id="ho" style="width:29%;" value="<?php echo $row['ho_kh']; ?>"/></td>
                              <td>
                              &nbsp;&nbsp;Tên &nbsp;
                             
                             <input name="ten" type="text" id="ten" style="width:25%;" value="<?php echo $row['ten_kh']; ?>"/>
                              </td>
                            </tr>
