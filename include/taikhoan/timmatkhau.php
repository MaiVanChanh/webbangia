...
<div style="width:100%; margin-left:3px; margin-right:3px;">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
		  <td>
			<?php include('include\taikhoan\xl_taikhoan.php');?>
			<br />
			...
			<form name="quenmatkhau" method="post" action="">
			 <table width="99.5%" border="0" align="center" class="dongbang" style="border-top:#CCCCCC 1px solid;border-right:#CCCCCC 1px solid; 					margin-top:10px; margin-bottom:10px;">
                  <tr>
            ...
            <input name="goiham" type="hidden" value="timmatkhau" />
