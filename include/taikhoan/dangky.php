...
<?php include_once('xl_taikhoan.php'); ?>
				<table width="100%" cellpadding="0" cellspacing="0" border="0" style="border:#CCCCCC 1px solid; margin-top:3px;">
					<tr>
						<td>
						  <form id="formdangky" name="formdangky" method="post" action="" onsubmit="return kiemtra_dangky()">
						  
						  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="dongbang" style="border-top:#CCCCCC 1px solid;border-right:#CCCCCC 1px solid; margin-top:10px; margin-bottom:10px;">
                            <tr>
                    ...
                    <textarea name="diachi" cols="31" rows="3" id="diachi" style="border-right:none;"> </textarea>
                            ...
                            <tr  class="gui1" > 
							  ...
							  <input class="gui" type="submit" name="Submit" value="Làm Trắng Form" style="background:#FFFFFF;"  onclick="dangky_onsubmit('dangky')"  />
                              <input class="gui" type="submit" name="Submit" value="Đăng Ký" style="background:#FFFFFF;" onclick="kiemtra_dangky()"/>
                           	  </td>
                            </tr>
                          </table>		
                          </form>		
