<?php
	...
	{
?>	
		<div style="width:99.5%px; margin-left:3px; margin-right:3px;">
		<table width="100%" cellpadding="0" cellspacing="0" border="0" style="border:#999999 1px solid; margin-top:3px;">
		<tr>
		<td>

		<p class="pp"><center><span style='color:#FF9900; font-size:18px; font-weight: bold'>Bạn Phải Là Thành Viên Mới Được Sử Dụng Chức Năng Mua Hàng</span>
		<br>
		<a href="#" onclick="dangky_onsubmit('dangky')" style='color:#0101DF;'>Bấm Vào Đây Để Đăng Ký Tài Khoản</a></center>
		</p>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<form name="giohangcuaban" action="" method="post">	
		...
		<input type="hidden" name="hanhdong" value="capnhatgiohang" />		
           ...
           <tr>
                    <td width="5%" align="center" height="30">STT</td>
                    <td width="30%" align="center">Tên Hàng</td>
                    <td width="20%" align="center">Số Lượng</td>
                    <td width="25%" align="center">Đơn Giá</td>
                    <td width="15%" align="center">Thành Tiền</td>
