...
<div class="spm hehe">
	...
	<h3 style="height:25px; text-align : center; font-size: 22px;" align="center" class="ht" ;  >Tin tức mới</h3>
</div>
<div>
		...
		<tr>
			<td>
				...
				<?php 
					...
					$tintucmoinhat=mysqli_query($conn,$strSQL);
					$rowTINMOI=mysqli_fetch_array($tintucmoinhat);
				?>
					<table width="95%%" cellpadding="0" cellspacing="0" border="0" style="border:#CCCCCC 1px solid; margin-top:3px;margin-bottom:5px;margin-left:20px;">
					<tr>
					<td>
...
<div class="spm">
	<h3  style="height:25px; text-align : center; font-size: 22px;" align="center" class="ht"  >Sản phẩm mới</h3>
</div>
				<?php
					$strSQL="SELECT * FROM giay ORDER BY ma_giay desc";
...
<div class="product">
			...
			<div class="item">
				<div class="name_pd">Tên sản phẩm : <span class="ten"><a href="#" onclick="chitiet('<?php echo $row['ma_giay']; ?>')"><b><?php echo $row['ten_giay']; ?></b></a>												<?php
				...
				<div class="name_pd">Giá bán:<span class="ten"><a href="#" onclick="chitiet('<?php echo $row['ma_giay']; ?>')"><b><?php echo number_format($row['gia'],0,'.','.'); ?> VNĐ</b></a></span>
