...
if($thongbao !="")
{
echo "<div style='width:99.5%; margin-left:3px; margin-right:3px;'>";
echo "<table width='100%' cellpadding='0' cellspacing='0' border='0' style='border:#E9E9E9 1px solid; margin-top:3px;'>";
echo "<tr>";
echo "<td>";

echo "<p class='pp'><center><span style='color:#FF9900; font-size:18px; font-weight: bold'>{$thongbao}</span>"; 
echo "<br>";
echo "<a href='index.php' target='_parent' style='color:#0101DF;' >Bấm Vào Đây Để Về Trang Chủ</a></center></p>";
