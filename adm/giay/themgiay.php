  ...
  <table width="750" height="132" border="0" cellpadding="2" cellspacing="0" class="admintable" style="border-right:#E9E9E9 1px solid; border-top:#E9E9E9 1px solid;" align="right">
	...
	<tr>
      <td colspan="2" align="left">
	  		&nbsp;&nbsp;Tên Giày:
        		<input name="tengiay" type="text" id="tengiay" maxlength="30" style="width:180px;" />
        	&nbsp;&nbsp;Loại Giày:
			...
			&nbsp;&nbsp;Giá:
          	  	<input name="giagiay" type="text" id="giagiay" maxlength="30" style="width:100px;" />
			&nbsp;&nbsp;&nbsp;Trạng Thái: 
    ...
    <tr>
      <td colspan="2" align="center">
		...
		<input name="goihamxuly" type="hidden" value="themgiay" />
