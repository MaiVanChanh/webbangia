...
<table width="750" cellpadding="2" cellspacing="0" border="0" class="admintable" style="border-right:#E9E9E9 1px solid; border-top:#E9E9E9 1px solid;" align="right">
	...
	<tr>
		...
		<tr>
			...
			<td width="180" align="center">Tên giay</td>
		...
		<tr>
			...
			<td align="center">
				<?php
					//lay ten giay thong qua ma giay
					$strSQL4="SELECT * FROM giay WHERE ma_giay={$rowCT['ma_giay']}";
					$giay=mysqli_query($ung,$strSQL4);
					$row4=mysqli_fetch_array($giay);
