...
<table width="500" border="0" class="admintable" cellpadding="2" cellspacing="0" align="center" style="margin-top:200px; border-right:solid 1px #E9E9E9; border-top:solid 1px #E9E9E9;">
  <tr>
    <th colspan="3">Đăng Nhập ADMIN </th>
  </tr>
  <tr>
    <td>&nbsp;&nbsp;Tên Đăng Nhập</td>
    <td><input name="txttendangnhap" type="text" id="txttendangnhap" style="width:200px;"/>   </td>
	<td rowspan="2"><img src="../images/gioithieu.png" width="184" height="164" border="0" /></td>
  </tr>
  <tr>
    <td>&nbsp;&nbsp;Mật Khẩu</td>
...
<?php } else { ?>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="960" align="center" style="margin-top:20px; margin-bottom:20px; background:#FFFFFF;">
		...
		<tr>
			...
			<div class="menuleft">
					<a href="#" onclick="adm_chuyentrang('quanlyloaigiay')">Quản Lý Loại Giày</a>
					<a href="#" onclick="adm_chuyentrang('quanlygiay')">Quản Lý Giày</a>
			...
			background:#FFFFFF; color:#999999; text-align:left; border-right:none; border-left:none;">
					<span class="demuc"> Tổng Số Loại Giày:</span> <?php echo $soloaigiay; ?>
					<br />
					<span class="demuc">Tổng Số Giày:</span> <?php echo $sogiay; ?>	
					<br />
			...
			<td width="760" valign="top">
					...
					if(isset($_POST['trangchuyen']))
					{
						...
						if($hienthi=='quanlyloaigiay')
							include_once('loaigiay/loaigiay.php');
						else if($hienthi=='quanlygiay')
							include_once('giay/giay.php');
							...
							/////////////////////////////////////////////////////////	
						else if($hienthi=='xlloaigiay')
							include_once('loaigiay/xl_loaigiay.php');
						else if($hienthi=='xlgiay')
							include_once('giay/xl_giay.php');
